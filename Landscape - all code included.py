...
# Function:     This MicroPython makes it possible to display text horizontally on the E-paper.
#               explanation will follow - either in the code or in the readme.
...
if __name__=='__main__':
    ...
    PrtStxt("Hi Arnie", 11, 1, 0)
    PrtStxt("Arnie !", 11, 2, 1)
    PrtLtxt("Hi Arnie", 90, 10, 0)
    PrtLtxt("Arnie!", 90, 7, 1)
